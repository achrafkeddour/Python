...
# Step 2: Custom Dataset class for multiple text files
class TextDataset(Dataset):
    def __init__(self, folder_path, tokenizer, block_size=128):
        self.examples = []
        file_paths = glob.glob(os.path.join(folder_path, "*.txt"))  # Load all .txt files in the folder
...
data_folder = "data_files"  # Put all your text files inside this folder
dataset = TextDataset(data_folder, tokenizer)
